_base_ = [
    '../_base_/models/ssd300.py', '../_base_/datasets/ShipRSImageNet_Augmented_MatchedRes_Level3_detection.py',
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=data_root + 'ShipRSImageNet_bbox_train_level_3.json',
